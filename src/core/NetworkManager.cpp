...
NetworkManager::NetworkManager(QueryClient& owning_client,
...
void NetworkManager::handle_accept(const asio::error_code& error, asio::ip::tcp::socket new_socket) {
...
void NetworkManager::do_read(int client_id) {
...
void NetworkManager::handle_read(int client_id, const asio::error_code& error, std::size_t bytes_read) {
...
void NetworkManager::receive_message(const std::vector<uint8_t>& message_bytes) {
